...
func init() {
	proto.RegisterType((*HelloRequest)(nil), "clientPb.HelloRequest")
	proto.RegisterType((*HelloResponse)(nil), "clientPb.HelloResponse")
	proto.RegisterType((*ClientStream)(nil), "clientPb.ClientStream")
	proto.RegisterType((*ServerStream)(nil), "clientPb.ServerStream")
}
...
var fileDescriptor_61ef911816e0a8ce = []byte{
	...
	,
}
...
func (c *helloServiceClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/clientPb.HelloService/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *helloServiceClient) Chat(ctx context.Context, opts ...grpc.CallOption) (HelloService_ChatClient, error) {
	stream, err := c.cc.NewStream(ctx, &_HelloService_serviceDesc.Streams[0], "/clientPb.HelloService/Chat", opts...)
	if err != nil {
		return nil, err
	}
...
func _HelloService_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/clientPb.HelloService/SayHello",
	}
...
var _HelloService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "clientPb.HelloService",
