...
func init() {
	proto.RegisterEnum("pb.HelloRequest_MSGID", HelloRequest_MSGID_name, HelloRequest_MSGID_value)
	proto.RegisterEnum("pb.HelloResponse_MSGID", HelloResponse_MSGID_name, HelloResponse_MSGID_value)
